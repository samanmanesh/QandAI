  ...
  return (
    <div className="relative">
      <textarea
        ...
        className="w-full aspect-[16/7] resize-none rounded-xl overflow-auto outline-none p-4   border border-neutral-400 opacity-95 text-base font-medium tracking-wide custom-scrollbar shadow-sm"
